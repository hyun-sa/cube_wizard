...
const c_prompt = {
  "type": "c_prompt",
  "message0": "User Prompt %1 with in %2",
  "args0": [
    {
      "type": "field_variable",
      "name": "VAR",
...
const c_input= {
  "type": "c_input",
  "message0": "User Input %1 with in %2",
  "args0": [
    {
      "type": "field_variable",
      "name": "VAR",
...
export const blocks = Blockly.common.createBlockDefinitionsFromJsonArray([addText, consolePrint, Alert, input, prompt, c_input, c_prompt]);
